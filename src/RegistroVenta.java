...
public class RegistroVenta extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel10.setBounds(0, 10, 50, 40);

        jLabel11.setText("ID incorrecto, no existente o no disponible");
        error.getContentPane().add(jLabel11);
        jLabel11.setBounds(50, 20, 280, 14);
        ...
        jLabel16.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/windows-info.png"))); // NOI18N
        informacion.getContentPane().add(jLabel16);
        jLabel16.setBounds(20, 10, 32, 32);

        jLabel17.setText("El cliente no se encuentra registrado");
        informacion.getContentPane().add(jLabel17);
        jLabel17.setBounds(60, 20, 220, 14);
        ...
        error2.setMinimumSize(new java.awt.Dimension(270, 140));
        error2.setModal(true);
        error2.setResizable(false);
        error2.getContentPane().setLayout(null);

        jLabel19.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/windows-error.png"))); // NOI18N
        error2.getContentPane().add(jLabel19);
        jLabel19.setBounds(10, 10, 40, 40);

        jLabel20.setText("Fecha erronea");
        error2.getContentPane().add(jLabel20);
        jLabel20.setBounds(50, 20, 120, 14);
        ...
        jLabel22.setText("¿Esta seguro que desea realizar");
        pregunta.getContentPane().add(jLabel22);
        jLabel22.setBounds(60, 10, 200, 14);
        ...
        jLabel23.setText("esta operacion?");
        pregunta.getContentPane().add(jLabel23);
        jLabel23.setBounds(90, 30, 130, 14);

        error3.setMaximumSize(new java.awt.Dimension(260, 130));
        error3.setMinimumSize(new java.awt.Dimension(260, 130));
        error3.setModal(true);
        error3.setPreferredSize(new java.awt.Dimension(260, 130));
        error3.setResizable(false);
        error3.getContentPane().setLayout(null);

        jLabel24.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/windows-error.png"))); // NOI18N
        error3.getContentPane().add(jLabel24);
        jLabel24.setBounds(10, 10, 40, 40);

        jLabel25.setText("Existe uno o mas campos vacios");
        error3.getContentPane().add(jLabel25);
        jLabel25.setBounds(50, 20, 220, 14);
        ...
        jEImagePanel1.add(jButton7);
        jButton7.setBounds(440, 710, 70, 30);
        ...
        jLabel9.setText("Registro VENTA");
        jLabel9.setBounds(130, 10, 230, 25);
        ...
        borrar2.setBounds(20, 380, 170, 40);
        ...
        finalizar.setBounds(220, 380, 170, 40);
        ...
        jLabel13.setBounds(220, 340, 90, 30);
        ...
        descuento.setBounds(130, 340, 60, 30);
        jDesktopPane1.add(descuento, javax.swing.JLayeredPane.DEFAULT_LAYER);

        total.setEditable(false);
        total.setBounds(310, 340, 80, 30);
        jDesktopPane1.add(total, javax.swing.JLayeredPane.DEFAULT_LAYER);

        jLabel15.setBackground(new java.awt.Color(0, 0, 0));
        jLabel15.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel15.setText("Sub-Total Bsf.:");
        jLabel15.setBounds(220, 300, 120, 30);
        jDesktopPane1.add(jLabel15, javax.swing.JLayeredPane.DEFAULT_LAYER);

        jDesktopPane1.setBounds(30, 170, 420, 440);
        ...
        venta.setBounds(150, 620, 170, 40);
        ...
        Panel.setBounds(30, 20, 480, 680);

        javax.swing.GroupLayout layout = new javax.swing.GroupLayout(getContentPane());
        getContentPane().setLayout(layout);
        layout.setHorizontalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jEImagePanel1, javax.swing.GroupLayout.DEFAULT_SIZE, 540, Short.MAX_VALUE)
        );
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jEImagePanel1, javax.swing.GroupLayout.DEFAULT_SIZE, 750, Short.MAX_VALUE)
        );
...
private void porcentaje(){
    if (descuento.getText().equalsIgnoreCase("")){
        descuento.setText("0");
        total.setText(subtotal.getText());    
    }
    else{
        float sub = Float.parseFloat(subtotal.getText());
        float desc = Float.parseFloat(descuento.getText());
        int porcentaje = Math.round(sub-(sub*((desc)/100))); 
        descuenton = desc;
        total.setText(Integer.toString(porcentaje));
    }    
}
    ...
    private void buscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buscarActionPerformed
        ...
        if(existe==false){
            sql = "SELECT Titulo,Precio,Cantidad FROM peliculas.peliculas WHERE idPelicula='"+codigo.getText()+"' AND Uso='Venta'";
    ...
    private void descuentoKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_descuentoKeyTyped
        int limite = 3;
        char C=evt.getKeyChar();
        if (((descuento.getText().length()== limite))||((C<'0')||(C>'9')))
            evt.consume();
    ...
    private void aceptar5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_aceptar5ActionPerformed
        ...
        for(int i=0;i<tamanolista;i++){     
            ...
            sql = "SELECT Cantidad FROM peliculas.peliculas WHERE idPelicula='"+idpelis.get(i)+"'";
            ...
            vendido = cantidadd1-cantidadd2;
            
            // resta peliculas vendidas a las del almacen
            sql = "UPDATE peliculas.peliculas SET Cantidad='"+Integer.toString(cantidadd2)+"' WHERE idPelicula='"+idpelis.get(i)+"'";
            cxn.Ejecutar(sql);
            
            // obtengo informacion de pelicula para registrar las peliculas vendidas
            if(vendido>0){
                int can=0;
                ResultSet verificar;
                ...
                verificar = cxn.Consulta("SELECT Cantidad FROM peliculas.peliculas WHERE idAuxiliar='"+idpelis.get(i)+"' AND Estatus='Vendida'");
                try{ 
                ...
                if(can==0){
                    // registro peliculas vendidas
                    sql = "INSERT INTO peliculas.peliculas (Titulo,Año,Genero,Censura,Reparto,Uso,Condicion,Cantidad,Precio,"
                        +"Veces_Alquilada,Distribuidor,Precio_Pedido,Fecha_Solicitud,Fecha_Esperada,Fecha_Entrega,Estatus,Registro,idAuxiliar) "
                        +"VALUES ('"+datospeliculas[0]+"','"+datospeliculas[1]+"','"+datospeliculas[2]+"','"+datospeliculas[3]+"',"
                        +"'"+datospeliculas[4]+"','"+datospeliculas[5]+"','"+datospeliculas[6]+"','"+Integer.toString(vendido)+"',"
                        +"'"+datospeliculas[8]+"','"+datospeliculas[9]+"','"+datospeliculas[10]+"','"+datospeliculas[11]+"',"
                        +"'"+datospeliculas[12]+"','"+datospeliculas[13]+"','"+datospeliculas[14]+"','Vendida','Caducado','"+idpelis.get(i)+"')";
                    cxn.Ejecutar(sql);
                }
                else{
                    can = can + vendido;
                    sql = "UPDATE peliculas.peliculas SET Cantidad='"+Integer.toString(can)+"' WHERE idAuxiliar='"+idpelis.get(i)+"' AND Estatus='Vendida'";
                    cxn.Ejecutar(sql);
                }
                // registrar venta
                float precio4 = Float.parseFloat(precios.get(i).toString());
                String precio5 = Integer.toString(Math.round(precio4-((precio4*descuenton)/100)));
                for (int j=0;j<vendido;j++){
                    sql = "INSERT INTO peliculas.ventas (idPelicula,Cedula,Descuento,Fecha_Venta,Precio_Real) VALUES ('"+idpelis.get(i)+"',"
                        +"'"+ced+"','"+Integer.toString(Math.round(descuenton))+"','"+fecha+"','"+precio5+"')";
                    cxn.Ejecutar(sql);
                }
            }  
        }
